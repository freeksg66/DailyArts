...
import com.github.dailyarts.ui.widget.imagespickers.container.GridViewForScrollView;
import com.github.dailyarts.ui.widget.imagespickers.container.SimpleImageAdapter;
...
//        private ImageLoader imageLoader;
        ...
        private String filePath = "/arts/pictures/";
        ...
        public Builder setContainer(ViewGroup container, int rowImageCount, boolean isDelete) {
            if (container.getChildCount() == 0) {
                ...
                if (isDelete) {
                    //间距3dp
                    gvView.setHorizontalSpacing(Utils.dp2px(container.getContext(), 3));
                    gvView.setVerticalSpacing(Utils.dp2px(container.getContext(), 3));
                } else {
                    //间距10dp
                    gvView.setHorizontalSpacing(Utils.dp2px(container.getContext(), 10));
                    gvView.setVerticalSpacing(Utils.dp2px(container.getContext(), 10));
                }
