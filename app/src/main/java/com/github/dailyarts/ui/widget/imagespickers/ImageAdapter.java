...
public class ImageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_CAMERA) {
            convertView = mLayoutInflater.inflate(R.layout.image_selector_item_camera, parent, false);
            convertView.setTag(null);
        } else if (type == TYPE_NORMAL) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mLayoutInflater.inflate(R.layout.image_selector_item_image, parent, false);
            ...
            if (showSelectIndicator) {
                ...
                if (selectedImageList.contains(getItem(position))) {
                    holder.photo_check.setImageResource(R.mipmap.image_selector_select_checked);
                    holder.photo_mask.setVisibility(View.VISIBLE);
                } else {
                    holder.photo_check.setImageResource(R.mipmap.image_selector_select_uncheck);
